...
# Laboratory 3: Classification with LDA/QDA/RDA and LogReg
##########################################################

#####################################
### Example 1: LDA/QDA with Iris data
#####################################

library(MASS)

## This is a very famous dataset; the task is to separate three species of flowers (Iris setosa, Iris virginica, Iris versicolor),
## given 4 measurements (sepal and petal width and length)
...
### PART1: Using LDA for visualization
### 
...
## For this example we lda() using a formula; this is most useful
...
####################################################################
### Example 3: Logistic Regression for admission into graduate school
####################################################################
...
# are comitted by predicting that many people are not going to be admitted (and they are)
...
####################################################################
## Example 4: Logistic regression for spam mail detection
####################################################################
...
####################################################################
#################### Exercise: the Bank Marketing Data Set
####################################################################
...
## Preparing dataset for modeling: we should consider taking log10 of other variables, scaling the continuous ones (after the eventual log10s), treat the '999' and 'unknown', balance the errors (if need be) ...
...
## First try LDA and QDA (and RDA, if needed or wanted)

...

## then try Logistic regression and AIC
